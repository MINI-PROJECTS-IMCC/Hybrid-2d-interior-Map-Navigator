...
public class fourth_floor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        points.add(new MapPoint("A", 0.05f, 0.48f));
        points.add(new MapPoint("B", 0.18f, 0.48f));
        points.add(new MapPoint("C", 0.5f, 0.48f));
        points.add(new MapPoint("D", 0.5f, 0.31f));
        points.add(new MapPoint("E", 0.3f, 0.31f));
        points.add(new MapPoint("F", 0.07f, 0.31f));
        points.add(new MapPoint("G", 0.5f, 0.25f));
        points.add(new MapPoint("H", 0.5f, 0.58f));
        points.add(new MapPoint("I", 0.4f, 0.62f));
        points.add(new MapPoint("J", 0.4f, 0.68f));
        ...
        paths.put("A", List.of("B"));
        paths.put("B", List.of("C","A"));
        paths.put("C", List.of("D","B","A","H"));
